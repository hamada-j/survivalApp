const {getEarthquakes} = require('../modules/equakes-module'), 
    {getNews} = require('../modules/news-module'), 
    {globalStatus} = require('../modules/global-module'), 
    {uvNow, uvForecast, weather} = require('../modules/air-module'), 
    {isoDateConverter, unixTimestampToDate} = require('../util/utilities'),
   // terminalImage = require('terminal-image'), 
    {satelliteMap, politicalMap} = require('../modules/maps-module'), 
    {cameraUrl} = require('../modules/camera-module'),
    got = require('got'),
